...
INSERT INTO lifebank_db.usuario (usr_id, usr_usuario, usr_password, usr_nombre, usr_apellido, usr_correo,urs_estado,urs_conteo_fallido, usr_created_by, usr_created_date, usr_modified_by, usr_modified_date) VALUES(2, 'eflores', '04e85978d5ed597ecfaf4ed222aaab05ca4c32b2898532ce0fe7cdf2cfc1dd5f502e40fdf0a205f47e22d422e5146b2f893c5817ef5e3da0ace6c72941f84040', 'Emilio', 'Flores', 'emilio@gmail.com','A',0, 'postgres', '2019-05-09 17:16:48.878', NULL, NULL);
...
insert into lifebank_db.cuentas_bancarias (cub_id,cub_nombre,cub_tip_id,cub_usr_id,cub_saldo) values ('003','Cuenta de Ahorro 1',1,2,500);
...
tra_tipo_cuenta int not null,
tra_fecha  timestamp not null,
tra_tipo   int not null,
tra_descripcion varchar(100) not null,
tra_referencia varchar(50) not null,
tra_fecha_creacion timestamp default now(),
constraint PK_TRANS primary key (tra_id)
);

create table lifebank_db.cuentas_beneficiarios(
ben_id serial not null,
ben_num_cuenta varchar(50) not null,
ben_nombre varchar(100) not null,
ben_correo varchar(50) not null,
ben_tip_cuenta int not null,
ben_usr_id int not null,
constraint PK_BENEFI primary key (ben_id),
constraint FK_BEN_TIPO_CUENTA foreign key(ben_tip_cuenta) references lifebank_db.tipo_producto (tip_id),
constraint FK_BEN_USUARIO foreign key(ben_usr_id) references lifebank_db.usuario (usr_id)
);